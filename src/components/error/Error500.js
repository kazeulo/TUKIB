...
export default function Error500() {
    ...
    return (
        <div class='error-container'>
            ...
            <h1 className="error-title">🔬 Experiment Failed! (500 Error) 🧪</h1>
            <p className="error-message">Looks like our servers ran into an unexpected reaction. The system is under analysis.</p>
