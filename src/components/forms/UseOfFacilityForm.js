...
const UseOfFacilityForm = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log('Use of Facility Form Data:', formData);
    };
    ...
    return (
        <div className='service-request-form'>
            <div className='form-title'><h3>Use of Facility Request Form</h3></div>
            <form className='service-request-form-contents' onSubmit={handleSubmit}>
                <div className='form-group'>
                    <label>Facility Type</label>
                    <input type='text' name='facilityType' value={formData.facilityType} onChange={handleInputChange} />
                </div>
                <div className='form-group'>
